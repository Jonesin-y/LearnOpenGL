...
public:
	...
	static::std::shared_ptr<VertexBuffer> Create(const void* data, unsigned int count) { return std::make_shared<VertexBuffer>(data, count); }
private:
...
public:
	...
	static::std::shared_ptr<IndexBuffer> Create(const void* data, unsigned int count) { return std::make_shared<IndexBuffer>(data, count); }
private:
	unsigned int m_RendererID;
