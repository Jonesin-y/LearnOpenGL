...
int main(void)
{
	...
	Material u_mapMaterial(32.0f, 1,2,3);
	float vertices[] = {
...
glm::vec3 cubePositions[] = 
{
	...
	Shader Light_shader = Shader("res/shaders/light.shader");
	...
	float rad = 0.0f;
	light.ApplyToShader(Basic_shader, "u_light");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Light_shader.Bind();
		//auto position1 = cubePositions[1];
